...
- Add global justfile for claude commands
- Add git templates for commits and GitHub workflows
- Add commitizen hook for conventional commits enforcement

### 📚 Documentation

- Update changelog for version 4.7.0
- Format @dataclass decorator as code in python conventions

### ⚙️ Miscellaneous Tasks

- Archive aider/ly/nom configs and add claude-code setup
- _(gemini)_ Restructure to selective symlinks, remove sensitive files
- _(archived_configs)_ Reorganize into subdirectories, drop flake8/pycodestyle
- _(just)_ Add aliases and helper recipes
...
- _(release)_ Update changelog for v4.8.0

### Ignore

- Add conductor/ and .pytest_cache to git/ignore
...
- _(models)_ Add pricing information for value for money models
- Update configurations for Gemini, Kitty, Ruff, and Yazi
- _(models)_ Add new model configuration for minimax paid
- _(helix)_ Disable pyls_mypy and add 'ty' language server for Python
- Update Python tooling and linting configurations
- Enhance gitignore with environment and OS-specific patterns
- Add *.egg-info/ to gitignore
- _(gemini)_ Configure initial state, enable preview features, and adjust shell environment
- _(ci)_ Add comprehensive pre-commit configuration
- _(python)_ Update uv configuration and add ruff to lint dependencies
...
- _(gemini)_ Remove obsolete mcpServers configuration
- _(stylix)_ Improve formatting and structure of font configuration
- _(helix)_ Switch Nix formatter and remove pylsp language server
...
- _(python)_ Added commands for deptry
...
- _(release)_ Update changelog for v4.6.0
