...
- *(gemini)* Restructure to selective symlinks, remove sensitive files
- *(archived_configs)* Reorganize into subdirectories, drop flake8/pycodestyle
- *(just)* Add aliases and helper recipes
...
- *(release)* Update changelog for v4.6.0
